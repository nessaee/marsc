...
dll = cdll.LoadLibrary("/home/ameer/Documents/marsc/playerone_sdk/PlayerOne_Camera_SDK_Linux_V3.8.1/lib/x64/libPlayerOneCamera.so") # Windows, if your python is 64bit, please copy dll file from lib\x64 folder, if python is 32bit, copy dll file from lib\x86
#dll = cdll.LoadLibrary("./libPlayerOneCamera.so") # Original Linux line # Linux, please copy the 4 'so' files of the corresponding architecture, eg: if your Linux is arm64(aarch64) architecture, please copy the 4 'so' files from lib\arm64
